...
export function Panel({
  ...
  return (
    <section className={cn("atlas-card animate-rise p-5 sm:p-6", className)}>
      {title ? (
...
export function Metric({
  ...
  return (
    <div className="atlas-card animate-rise group p-5 transition-transform duration-300 hover:-translate-y-0.5">
      ...
      <p className={cn("num mt-3 text-2xl font-bold sm:text-[26px]", toneClass)}>
